...
SELECT * FROM (VALUES
    ...
    ('log_days_since_last_event', 'days_since_last_event', 'DURATION',
     'KEEP_CHALLENGER', 'LOG1P', 'ZERO_PLUS_MISSING_FLAG',
     'Informatif tetapi hampir duplikat umur installation'),
    ('log_days_at_last_location', 'days_at_last_location', 'DURATION',
     'KEEP_CHALLENGER', 'LOG1P', 'ZERO_PLUS_MISSING_FLAG',
     'Informatif tetapi sangat berkorelasi dengan umur dan last-event recency'),
